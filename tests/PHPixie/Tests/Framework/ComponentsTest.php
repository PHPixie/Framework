...
class ComponentsTest extends \PHPixie\Test\Testcase
{
    ...
    {
        $configData = $this->prepareConfig('social');

        $social = $this->components->social();
        $this->assertInstance($social, '\PHPixie\Social');
        $this->assertInstance($social->builder(), '\PHPixie\Social\Builder', array(
            'configData' => $configData
        ));

        $this->assertSame($social, $this->components->social());
    }
